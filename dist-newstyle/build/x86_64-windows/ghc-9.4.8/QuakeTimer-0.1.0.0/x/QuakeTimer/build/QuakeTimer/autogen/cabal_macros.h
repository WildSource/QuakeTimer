...
/* package QuakeTimer-0.1.0.0 */
#ifndef VERSION_QuakeTimer
#define VERSION_QuakeTimer "0.1.0.0"
#endif /* VERSION_QuakeTimer */
#ifndef MIN_VERSION_QuakeTimer
#define MIN_VERSION_QuakeTimer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_QuakeTimer */
...
#define CURRENT_COMPONENT_ID "QuakeTimer-0.1.0.0-inplace-QuakeTimer"
